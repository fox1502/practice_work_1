...
## Висновки: Під час виконання роботи було успішно опановано ключові концепції мови Go. На практиці реалізовано об'єктно-орієнтований підхід через структури, методи з одержувачами та неявну імплементацію інтерфейсів (duck typing), а також закріплено стандартний механізм явного опрацювання помилок.
